...
const usersTable = mongoose.model('usersTable', usersSchema);

const users = new usersTable({ name: 'Users' });
...
const postsTable = mongoose.model('postsTable', postsSchema);

const posts = new postsTable({ name: 'Posts' });
...
const commentsTable = mongoose.model('commentsTable', commentsSchema);

const comments = new commentsTable({ name: 'Comments' });
